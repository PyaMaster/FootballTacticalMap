...
class CoordinateTransformer:
    def __init__(self, keypoints_displacement_mean_tol=10, max_track_length=35, ball_track_dist_thresh=100):
        self.keypoints_displacement_mean_tol = keypoints_displacement_mean_tol
        self.max_track_length = max_track_length
        self.ball_track_dist_thresh = ball_track_dist_thresh

    def calculate_homography(self, frame_nbr, detected_labels, detected_labels_src_pts, detected_labels_dst_pts,
                             detected_labels_prev, detected_labels_src_pts_prev):
    ...
    def transform_coordinates(self, h, detected_ppos_src_pts, detected_ball_src_pos, ball_track_history):
        ...
        if len(ball_track_history) > self.max_track_length:
