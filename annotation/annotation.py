...
class Annotator:
    def annotate_frame(self, annotated_frame, bboxes_p, confs_p, labels_p, obj_palette_list, colors_dic, players_teams_list,
    ...
    def annotate_tactical_map(self, tac_map_copy, annotated_frame, ball_track_history, prev_frame_time):
