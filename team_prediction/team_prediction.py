...
class TeamPredictor:
    def __init__(self, nbr_team_colors=2):
        self.nbr_team_colors = nbr_team_colors

    def create_colors_info(self, team1_name, team1_p_color, team1_gk_color, team2_name, team2_p_color, team2_gk_color):
    ...
    def predict_team(self, frame, labels_p, bboxes_p, color_list_lab):
            ...
            for distance_feats in players_distance_features:
                ...
                for dist_list in distance_feats:
                    team_idx = dist_list.index(
                        min(dist_list)) // self.nbr_team_colors  # Assign team index for current color based on min distance
